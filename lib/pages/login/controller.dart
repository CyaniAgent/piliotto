...
import 'package:piliotto/http/login.dart';
import 'package:gt3_flutter_plugin/gt3_flutter_plugin.dart';
import 'package:piliotto/models/login/index.dart';
  ...
  Future getCaptcha(oncall) async {
    ...
    if (Platform.isAndroid || Platform.isIOS) {
      ...
      if (result['status']) {
        CaptchaDataModel captchaData = result['data'];
        // 模拟验证成功
        captchaData.validate = 'mock_validate';
        captchaData.seccode = 'mock_seccode';
        SmartDialog.dismiss();
        oncall(captchaData);
      }
    }
